<template>
  <div class="invoice-wrap flex flex-column" ref="containers" @click="checkClick">
    <form @submit.prevent="submitForm" class="invoice-content" >
      ...
      <div class="save flex">
        <div class="left">
          <button type="button" @click="closeInv" class="red">Cancel</button>
        </div>
...
export default {
  ...
  methods: {
    checkClick(e){
      if(e.target == this.$refs.containers){
    ...
    addNewItem() {
      // const addCount = this.invoiceItemList.length +
